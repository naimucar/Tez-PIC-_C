...
#fuses xt,noprotect,nowdt           //osilatörü seç,wdt'yi durdur 
...
#define start input(pin_a0)         //A0 pinini "start " diye taný 
#define stop input(pin_a1)          //A1 pinini "stop "diye taný 
